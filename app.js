...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Users
    const users = {
        'usuariobasico@email.com': { password: 'senha123', type: 'basic' }
    };
    ...
    function updateContentAccess() {
        ...
        if (currentUserType === 'premium') {
            ...
            if (basicLock) basicLock.style.display = 'block';

            if (manualCard) manualCard.classList.add('locked');
            if (golpeCard) golpeCard.classList.add('locked');
        }
    ...
    function renderNavigation(type) {
        ...
        if (type === 'basic') {
            items = [
                ...
                { id: 'tab-dicas', icon: 'lightbulb', label: 'Dicas' },
...
// PDF Generation Logic
function generatePDF(type, action = 'save') {
...
const communityTips = [
    {
        ...
        text: "Sempre deixo o vidro do passageiro fechado em sinais. Evitou um furto ontem na Av. Brasil."
    },
    {
        name: "Ana P.",
        avatar: "https://randomuser.me/api/portraits/women/44.jpg",
        text: "Se o passageiro mudar a rota no meio do caminho para um lugar estranho, eu paro num posto."
    },
    {
        name: "Roberto S.",
        avatar: "https://randomuser.me/api/portraits/men/45.jpg",
        text: "Nunca fico parado esperando corrida com o carro destravado. Travas sempre acionadas!"
    },
    {
        name: "Juliana F.",
        avatar: "https://randomuser.me/api/portraits/women/68.jpg",
        text: "Instalei uma câmera interna e o comportamento dos passageiros mudou da água pro vinho."
    },
    {
        name: "Marcos T.",
        avatar: "https://randomuser.me/api/portraits/men/22.jpg",
        text: "Evito corridas em dinheiro à noite em áreas que não conheço bem. Segurança em primeiro lugar."
    },
    {
        name: "Fernanda L.",
        avatar: "https://randomuser.me/api/portraits/women/12.jpg",
        text: "Compartilho minha localização em tempo real com meu marido sempre que pego uma corrida longa."
    },
    {
        name: "Paulo R.",
        avatar: "https://randomuser.me/api/portraits/men/15.jpg",
        text: "Sempre verifico o banco traseiro ao final de cada corrida para garantir que ninguém esqueceu nada (ou se escondeu)."
    }
];
...
function renderTips() {
    ...
    tipsList.innerHTML = ''; // Clear existing

    communityTips.forEach(tip => {
        const tipCard = document.createElement('div');
        tipCard.className = 'person-tip-card';
        tipCard.innerHTML = `
            <div class="person-avatar">
                <img src="${tip.avatar}" alt="${tip.name}">
            </div>
            <div class="person-content">
                <h4 class="person-name">${tip.name}</h4>
                <p class="person-text">"${tip.text}"</p>
            </div>
        `;
...
// Call renderTips on load
document.addEventListener('DOMContentLoaded', () => {
    // Wait a bit to ensure DOM is ready and other scripts ran
